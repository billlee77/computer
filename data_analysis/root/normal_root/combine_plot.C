{
  ...
  TFile * filepi = new TFile("pi.root", "read");
  TFile * filep = new TFile("p.root", "read");
  TFile * filek = new TFile("k.root", "read");
  ...
  effpi->GetYaxis()->SetTitleOffset(0.5);
  effpi->GetYaxis()->SetTitleSize(0.06);
  effpi->Draw("AP");
  ...
  effk->GetXaxis()->SetTitleOffset(0.8);
  effk->GetXaxis()->SetTitleSize(0.06);
