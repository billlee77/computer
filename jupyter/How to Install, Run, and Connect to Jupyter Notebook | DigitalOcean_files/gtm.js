...
"resource": {
  ...
  "rules":[
    [["if",0,1],["add",0]],
    [["if",1,3,4,5],["add",1,38,39,40,41,93]],
    [["if",6],["add",2,3,4,16,25,26,29,90,97]],
    [["if",7],["add",2,3,4,16,25,26,29,90,97]],
    [["if",0,1,8,9],["add",4,25,26,29,90,97]],
    [["if",11],["unless",10],["add",5,6,23,24,28,30,67,89,104,105]],
    ...
    [["if",23,37,38],["add",33]],
    [["if",23,30,39],["add",33]],
    [["if",40],["add",34,35,36,37,92]],
    [["if",1,3,8,41],["add",42,43,44,45,94]],
    [["if",14,42],["add",46,47,48,49,50,95]],
    [["if",43,44],["add",51,52,53,54,62,98]],
    [["if",45,46],["add",55,56,57,58,59,99]],
    [["if",47],["add",60]],
    [["if",48],["add",61,63,110]],
    [["if",48,49],["add",64,70,108]],
    [["if",1,50],["add",65]],
    [["if",14,51,52],["add",66]],
    [["if",48,53],["add",68,103]],
    [["if",48,54],["add",69,102]],
    ...
    [["if",57],["add",74]],
    [["if",58],["add",75,112]],
    [["if",38],["add",76,78,79,80,81,83,84,85,91]],
    [["if",38,59],["add",77]],
    [["if",30],["add",82]],
    [["if",1,3],["unless",16],["add",86]],
    [["if",11,60],["add",86,100]],
    [["if",1,50,61],["add",87]],
    [["if",1,62],["add",87]],
    [["if",1],["unless",63],["add",88]],
    [["if",1,64],["add",96]],
    [["if",11,23],["unless",65],["add",100]],
    [["if",14,43,66],["add",107]],
    [["if",43,67],["add",109]],
    [["if",1,68],["add",111]],
...
var Dg=[I.C,I.K],Eg=function(a){var b=a[I.ad];b&&Af(40);var c=a[I.qe];c&&Af(41);for(var d=Ta(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==I.ad&&f!==I.qe)if(-1<Ua(Dg,f)){var g=f,h=a[f],l=d[e];og().set(g,h,l,"US","US-VA",c)}else{}},Fg=function(a,
...
function Zo(a,b){}function $o(a,b,c){};var ap=!!n.MutationObserver,bp=void 0,cp=function(a){if(!bp){var b=function(){var c=K.body;if(c)if(ap)(new MutationObserver(function(){for(var e=0;e<bp.length;e++)M(bp[e])})).observe(c,{childList:!0,subtree:!0});else{var d=!1;ag(c,"DOMNodeInserted",function(){d||(d=!0,M(function(){d=!1;for(var e=0;e<bp.length;e++)M(bp[e])}))})}};bp=[];K.body?b():M(b)}bp.push(a)};
var dp=function(a,b,c){function d(){var g=a();f+=e?(jb()-e)*g.playbackRate/1E3:0;e=jb()}var e=0,f=0;return{createEvent:function(g,h,l){var m=a(),p=m.Ld,q=void 0!==l?Math.round(l):void 0!==h?Math.round(m.Ld*h):Math.round(m.zf),r=void 0!==h?Math.round(100*h):0>=p?0:Math.round(q/p*100),u=K.hidden?!1:.5<=Rg(c);d();var t=void 0;void 0!==b&&(t=[b]);var v=vo(c,"gtm.video",t);v["gtm.videoProvider"]="youtube";v["gtm.videoStatus"]=g;v["gtm.videoUrl"]=m.url;v["gtm.videoTitle"]=m.title;v["gtm.videoDuration"]=
Math.round(p);v["gtm.videoCurrentTime"]=Math.round(q);v["gtm.videoElapsedTime"]=Math.round(f);v["gtm.videoPercent"]=r;v["gtm.videoVisible"]=u;return v},Nf:function(){e=jb()},jb:function(){d()}}};var ep=["www.youtube.com","www.youtube-nocookie.com"],fp,gp=!1,hp=0;
...
return Nb(c,this.g,d)};function Gp(a){var b;var h=!1;return Nb(b,this.g,h)};var Hp=function(a){var b;return b};function Ip(a,b){b=void 0===b?!0:b;var c;return c};function Jp(a){var b=null;return b};function Kp(a,b){var c;return c};function Lp(a,b){var c;return c};function Mp(a){var b="";return b};function Np(a,b){var c;return c};function Op(a){var b="";H(F(this),["component:?string"],arguments),lf(this,"get_url",a),b=bh(dh(n.location.href),a);return b};function Pp(){lf(this,"get_user_agent");return n.navigator.userAgent};function Qp(a,b){};var Rp={};
function Sp(a,b,c,d){};function Tp(a){var b=!0;return b};var Up=function(){return!1},Vp={getItem:function(a){var b=null;return b},setItem:function(a,
...
;var hq=function(a){for(var b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);128>e?b[c++]=e:(2048>e?b[c++]=e>>6|192:(55296==(e&64512)&&d+1<a.length&&56320==(a.charCodeAt(d+1)&64512)?(e=65536+((e&1023)<<10)+(a.charCodeAt(++d)&1023),b[c++]=e>>18|240,b[c++]=e>>12&63|128):b[c++]=e>>12|224,b[c++]=e>>6&63|128),b[c++]=e&63|128)}return b};function iq(a,b,c,d){var e=this;var f=function(v,x){var z=new Bb;z.set("name",v);z.set("message",x);return z},g=function(v,x){var z=new Uint8Array(v);if(2===x){for(var w="",y=0;y<z.length;y++){var B=z[y].toString(16);w+=1===B.length?"0"+B:B}return w}for(var C=Array(z.length),D=0;D<z.length;D++)C[D]=z[D];var E=C.map(function(J){return String.fromCharCode(J)}).join("");return n.btoa(E)};H(F(this),["input:!string","onSuccess:!Fn","onFailure:?Fn"],arguments);
var h=d instanceof Bb?Pb(d):{},l=1;switch(h.outputEncoding){case "hex":l=2;break;default:l=1}c=c||new xb("emptyFn",function(){});for(var m=n.msCrypto,p=n.crypto,q=hq(a),r=new Uint8Array(q.length),u=0;u<q.length;u++)r[u]=q[u];if(p&&p.subtle)p.subtle.digest("SHA-256",r).then(function(v){return void b.g(e.g,g(v,l))},function(v){return void c.g(e.g,f(v.name,v.message))});else if(m&&m.subtle){var t=
m.subtle.digest("SHA-256",r);t.oncomplete=function(v){return void b.g(e.g,g(v.target.result,l))};t.onerror=function(v){return void c.g(e.g,f(v.target.result.name,v.target.result.message))}}else c.g(this.g,f("BrowserNotSupported","This method is not supported in this browser."));};function jq(a,b,c){}
...
Y.h.ytl=["google"],function(){function a(){var t=Math.round(1E9*Math.random())+"";return K.getElementById(t)?a():t}function b(t,v){if(!t)return!1;for(var x=0;x<p.length;x++)if(0<=t.indexOf("//"+p[x]+"/"+v))return!0;return!1}function c(t,v){var x=t.getAttribute("src");if(b(x,"embed/")){if(0<x.indexOf("enablejsapi=1"))return!0;if(v){var z=t.setAttribute,w;var y=-1!==x.indexOf("?")?"&":"?";if(-1<x.indexOf("origin="))w=x+y+"enablejsapi=1";else{if(!r){var B=R("document");r=B.location.protocol+"//"+B.location.hostname;
B.location.port&&(r+=":"+B.location.port)}w=x+y+"enablejsapi=1&origin="+encodeURIComponent(r)}z.call(t,"src",w);return!0}}return!1}function d(t,v){if(!t.getAttribute("data-gtm-yt-inspected-"+v.ne)&&(t.setAttribute("data-gtm-yt-inspected-"+v.ne,"true"),c(t,v.Qb))){t.id||(t.id=a());var x=R("YT"),z=x.get(t.id);z||(z=new x.Player(t.id));var w=f(z,v),y={},B;for(B in w)y.sb=B,w.hasOwnProperty(y.sb)&&z.addEventListener(y.sb,function(C){return function(D){return w[C.sb](D.data)}}(y)),y={sb:y.sb}}}function e(t){M(function(){function v(){for(var z=
x.getElementsByTagName("iframe"),w=z.length,y=0;y<w;y++)d(z[y],t)}var x=R("document");v();cp(v)})}function f(t,v){var x,z;function w(){S=dp(function(){return{url:L,title:W,Ld:T,zf:t.getCurrentTime(),playbackRate:aa}},v.ne,t.getIframe());T=0;W=L="";aa=1;return y}function y(ya){switch(ya){case q.PLAYING:T=Math.round(t.getDuration());L=t.getVideoUrl();if(t.getVideoData){var ha=t.getVideoData();W=ha?ha.title:""}aa=t.getPlaybackRate();v.Gd?Gr(S.createEvent("start")):S.jb();va=l(v.ce,v.be,t.getDuration());
return B(ya);default:return y}}function B(){wa=t.getCurrentTime();U=Br().getTime();S.Nf();Q();return C}function C(ya){var ha;switch(ya){case q.ENDED:return E(ya);case q.PAUSED:ha="pause";case q.BUFFERING:var Ma=t.getCurrentTime()-wa;ha=1<Math.abs((Br().getTime()-U)/1E3*aa-Ma)?"seek":ha||"buffering";t.getCurrentTime()&&(v.Fd?Gr(S.createEvent(ha)):S.jb());P();return D;case q.UNSTARTED:return w(ya);default:return C}}function D(ya){switch(ya){case q.ENDED:return E(ya);case q.PLAYING:return B(ya);case q.UNSTARTED:return w(ya);
default:return D}}function E(){for(;z;){var ya=x;zr(z);ya()}v.Ed&&Gr(S.createEvent("complete",1));return w(q.UNSTARTED)}function J(){}function P(){z&&(zr(z),z=0,x=J)}function Q(){if(va.length&&0!==aa){var ya=-1,ha;do{ha=va[0];if(ha.V>t.getDuration())return;ya=(ha.V-t.getCurrentTime())/aa;if(0>ya&&(va.shift(),0===va.length))return}while(0>ya);x=function(){z=0;x=J;0<va.length&&va[0].V===ha.V&&(va.shift(),Gr(S.createEvent("progress",ha.Zb,ha.ac)));Q()};z=Ar(x,1E3*ya)}}var S,va=[],T,L,W,aa,wa,U,Fa=w(q.UNSTARTED);
z=0;x=J;return{onStateChange:function(ya){Fa=Fa(ya)},onPlaybackRateChange:function(ya){wa=t.getCurrentTime();U=Br().getTime();S.jb();aa=ya;P();Q()}}}function g(t){for(var v=t.split(","),x=v.length,z=[],w=0;w<x;w++){var y=parseInt(v[w],10);isNaN(y)||100<y||0>y||z.push(y/100)}z.sort(function(B,C){return B-C});return z}function h(t){for(var v=t.split(","),x=v.length,z=[],w=0;w<x;w++){var y=parseInt(v[w],10);isNaN(y)||0>y||z.push(y)}z.sort(function(B,C){return B-C});return z}function l(t,v,x){var z=t.map(function(B){return{V:B,
ac:B,Zb:void 0}});if(!v.length)return z;var w=v.map(function(B){return{V:B*x,ac:void 0,Zb:B}});if(!z.length)return w;var y=z.concat(w);y.sort(function(B,C){return B.V-C.V});return y}function m(t){var v=!!t.vtp_captureStart,x=!!t.vtp_captureComplete,z=!!t.vtp_capturePause,w=g(t.vtp_progressThresholdsPercent+""),y=h(t.vtp_progressThresholdsTimeInSeconds+""),B=!!t.vtp_fixMissingApi;if(v||x||z||w.length||y.length){var C={Gd:v,Ed:x,Fd:z,be:w,ce:y,Qb:B,ne:void 0===t.vtp_uniqueTriggerId?"":t.vtp_uniqueTriggerId},
D=R("YT"),E=function(){e(C)};M(t.vtp_gtmOnSuccess);if(D)D.ready&&D.ready(E);else{var J=R("onYouTubeIframeAPIReady");Hr("onYouTubeIframeAPIReady",function(){J&&J();E()});M(function(){for(var P=R("document"),Q=P.getElementsByTagName("script"),S=Q.length,va=0;va<S;va++){var T=Q[va].getAttribute("src");if(b(T,"iframe_api")||b(T,"player_api"))return}for(var L=P.getElementsByTagName("iframe"),W=L.length,aa=0;aa<W;aa++)if(!u&&c(L[aa],C.Qb)){O("https://www.youtube.com/iframe_api");u=!0;break}})}}else M(t.vtp_gtmOnSuccess)}
var p=["www.youtube.com","www.youtube-nocookie.com"],q={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},r,u=!1;(function(t){Y.__ytl=t;Y.__ytl.i="ytl";Y.__ytl.m=!0;Y.__ytl.priorityOverride=0})(function(t){t.vtp_triggerStartOption?m(t):Jk(function(){m(t)})})}();
...
"set",r);f(g+"require",b.vtp_optimizeContainerId,{dataLayer:"dataLayer"});f(b.vtp_gtmOnSuccess);f(g+"require","render");a||(a=!0,O(u,function(){return Vk().loaded||b.vtp_gtmOnFailure()},b.vtp_gtmOnFailure));var t=R("dataLayer"),v=t&&t.hide;v&&(v.end||!0===v["GTM-KHWBBT"])&&(v[b.vtp_optimizeContainerId]=!0)}else M(b.vtp_gtmOnFailure)})}();
...
"ea");f("vtp_eventLabel","el");f("vtp_eventValue","ev");d.push(e);b.vtp_gtmOnSuccess()}else if(a)b.vtp_gtmOnSuccess();else try{O("//bat.bing.com/bat.js",function(){var g=Bf(R("UET"),{ti:b.vtp_tagId,q:d,tm:"gtm001"});n[c]=g;g.push("pageLoad");b.vtp_gtmOnSuccess()},b.vtp_gtmOnFailure),a=!0}catch(g){M(b.vtp_gtmOnFailure)}})}();Y.h.smm=["google"],function(){(function(a){Y.__smm=a;Y.__smm.i="smm";Y.__smm.m=!0;Y.__smm.priorityOverride=0})(function(a){var b=a.vtp_input,c=us(a.vtp_map,"key","value")||{},d=c.hasOwnProperty(b)?c[b]:a.vtp_defaultValue;Pr(d,"smm",a.vtp_gtmEventId);return d})}();
